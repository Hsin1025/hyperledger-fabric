...
function createOrg4() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:11054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer2 msp"
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:11054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:11054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/tls" --enrollment.profile tls --csr.hosts peer1.org4.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer2-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@localhost:11054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/tls" --enrollment.profile tls --csr.hosts peer2.org4.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg5() {
  ...
  cp "${PWD}/organizations/fabric-ca/org5/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org5.example.com/ca/ca.org4.example.com-cert.pem"
  ...
  infoln "Registering peer1"
  set -x
  fabric-ca-client register --caname ca-org5 --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/org5/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer1 msp"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:12054 --caname ca-org5 -M "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org5/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  cp "${PWD}/organizations/peerOrganizations/org5.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/msp/config.yaml"
  ...
  infoln "Generating the peer1-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:12054 --caname ca-org5 -M "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls" --enrollment.profile tls --csr.hosts peer1.org5.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org5/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  # Copy the tls CA cert, server cert, server keystore to well known file names in the peer's tls directory that are referenced by peer startup config
  cp "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/ca.crt"
  cp "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/signcerts/"* "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/server.crt"
  cp "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/keystore/"* "${PWD}/organizations/peerOrganizations/org5.example.com/peers/peer1.org5.example.com/tls/server.key"
